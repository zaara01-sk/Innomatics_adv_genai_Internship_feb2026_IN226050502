...
orders   = []   # bulk/company orders
feedback = []   # customer feedback
cart     = []   # Day 5 – shopping cart (resets on server restart)
...
# Q1 & Q4 — Add item to cart (handles duplicates by updating qty)
@app.post("/cart/add")
def add_to_cart(
    ...
    # If already in cart → update quantity (Q4)
    for item in cart:
...
# Q5 — Remove item from cart by product_id
...
# Q5 & Q6 — Checkout: place one order per cart item, then clear cart
